...
<?= $this->include('layout/print_blank_button', ['printBlankUrl' => 'pencucian-bahan/export-pdf-blank']) ?>
...
<div class="mb-4 animate-in">
    ...
    <h4 class="mb-1" style="font-weight: 700;">Buat Form Pencucian Bahan</h4>
</div>
<form action="<?= site_url('pencucian-bahan/store') ?>" method="post">
            ...
            <table class="table table-premium mb-0" id="item-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="items[0][bahan_kimia]" class="form-control form-control-sm" placeholder="Contoh: ya/tidak"></td>
                        <td><input type="text" name="items[0][benda_asing]" class="form-control form-control-sm" placeholder="Contoh: ya/tidak"></td>
                        <td><input type="text" name="items[0][tindak_lanjut]" class="form-control form-control-sm"></td>
                        <td><input type="time" name="items[0][jam_produksi]" class="form-control form-control-sm"></td>
