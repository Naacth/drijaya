...
<div class="mb-4 animate-in">
    ...
    <h4 class="mb-1" style="font-weight: 700;">Edit Form Thawing Chiller</h4>
</div>
<form action="<?= site_url('thawing-chiller/update/' . $header['id']) ?>" method="post">
            ...
            <table class="table table-premium mb-0" id="item-table" style="min-width: 1000px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="items[<?= $i ?>][jumlah]" class="form-control form-control-sm" value="<?= $item['jumlah'] ?>"></td>
                        <td><input type="datetime-local" name="items[<?= $i ?>][tgl_jam_keluar_freezer]" class="form-control form-control-sm" value="<?= $item['tgl_jam_keluar_freezer'] ? str_replace(' ', 'T', $item['tgl_jam_keluar_freezer']) : '' ?>"></td>
                        <td><input type="datetime-local" name="items[<?= $i ?>][tgl_jam_selesai_thawing]" class="form-control form-control-sm" value="<?= $item['tgl_jam_selesai_thawing'] ? str_replace(' ', 'T', $item['tgl_jam_selesai_thawing']) : '' ?>"></td>
                        <td><input type="datetime-local" name="items[<?= $i ?>][tgl_jam_pemasakan]" class="form-control form-control-sm" value="<?= $item['tgl_jam_pemasakan'] ? str_replace(' ', 'T', $item['tgl_jam_pemasakan']) : '' ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][paraf]" class="form-control form-control-sm" value="<?= $item['paraf'] ?>"></td>
