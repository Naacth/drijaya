...
<head>
    ...
    <style>
        ...
        .table th { background-color: #f2f2f2; font-weight: bold; padding: 6px; border: 1px solid #000; text-transform: uppercase; font-size: 9px; }
        .table td { padding: 6px; border: 1px solid #000; font-size: 10px; }
...
<body onload="window.print()">
    ...
    <div class="header">
        ...
        <div class="title-container">
            <h1 class="title">Checklist Pemeriksaan Higiene Personil</h1>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th rowspan="2" width="60">Paraf</th>
                <th rowspan="2">Keterangan</th>
            </tr>
            <tr>
                <th width="35">Kuku</th>
                <th width="40">Rambut</th>
                <th width="45">Pakaian</th>
                <th width="35">APD</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?= isset($row['pakaian']) ? '✓' : '-' ?></td>
                <td class="text-center"><?= isset($row['apd']) ? '✓' : '-' ?></td>
