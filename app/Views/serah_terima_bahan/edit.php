...
<div class="mb-4 animate-in">
    ...
    <h4 class="mb-1" style="font-weight: 700;">Edit Form Serah Terima Bahan</h4>
</div>
<form action="<?= site_url('serah-terima-bahan/update/' . $header['id']) ?>" method="post">
    <div class="data-card animate-in" style="animation-delay: 0.1s;">
        <div class="card-body p-4">
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label">Nama Pengirim</label><input type="text" name="nama_pengirim" class="form-control" required value="<?= $header['nama_pengirim'] ?>"></div>
                <div class="col-md-4"><label class="form-label">Nama Penerima</label><input type="text" name="nama_penerima" class="form-control" required value="<?= $header['nama_penerima'] ?>"></div>
            </div>
        </div>
    </div>
    <div class="data-card mt-4 animate-in" style="animation-delay: 0.15s;">
        ...
        <div class="table-responsive">
            <table class="table table-premium mb-0" id="item-table" style="min-width: 1000px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="time" name="items[<?= $i ?>][jam]" class="form-control form-control-sm" value="<?= $item['jam'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][nama_bahan]" class="form-control form-control-sm" required value="<?= $item['nama_bahan'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][tujuan_penggunaan]" class="form-control form-control-sm" value="<?= $item['tujuan_penggunaan'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][gramasi_per_porsi]" class="form-control form-control-sm" value="<?= $item['gramasi_per_porsi'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][jumlah_awal]" class="form-control form-control-sm" value="<?= $item['jumlah_awal'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][jumlah_tidak_layak]" class="form-control form-control-sm" value="<?= $item['jumlah_tidak_layak'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][tindak_lanjut]" class="form-control form-control-sm" value="<?= $item['tindak_lanjut'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][jumlah_akhir]" class="form-control form-control-sm" value="<?= $item['jumlah_akhir'] ?>"></td>
        ...
        <div class="card-body bg-light border-top p-3 text-end"><button type="submit" class="btn btn-primary px-4">Perbarui Form</button></div>
    </div>
</form>
<script>
