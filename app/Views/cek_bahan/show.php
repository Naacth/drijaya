...
<div class="d-flex justify-content-between align-items-center mb-4 animate-in">
    ...
    <div class="d-flex gap-2 flex-wrap align-items-center">
        <?= $this->include('layout/print_blank_button', ['printBlankUrl' => 'cek-bahan-baku/export-pdf-blank', 'printBlankRoles' => ['aslap', 'admin', 'pic'], 'printBlankWrapperClass' => 'mb-0']) ?>
        <?php if (session()->get('role') === 'admin' || session()->get('role') === 'aslap'): ?>
        <a href="<?= site_url('cek-bahan-baku/edit/'.$header['id']) ?>" class="btn btn-primary">
