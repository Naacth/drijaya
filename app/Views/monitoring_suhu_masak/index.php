            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center text-nowrap">
                        ...
                        <a href="<?= site_url('monitoring-suhu-masak/delete/' . $form['id']) ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i> Hapus</a>
                        <?php endif; ?>
                    </td>
                </tr>
