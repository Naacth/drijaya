...
<body onload="window.print()">
    ...
    <div class="page-container">
        ...
        <table class="info-table">
            <tr>
                <td class="label">Tanggal Monitoring</td><td class="value">: <?= date('d/m/Y', strtotime($header['tanggal'])) ?></td>
            </tr>
            <tr>
                <td class="label">Pelaksana (Cook)</td><td class="value">: <?= esc($header['nama_pelaksana']) ?></td>
            </tr>
            <tr>
                <td class="label">Pemeriksa (Gizi)</td><td class="value">: <?= esc($header['nama_pemeriksa']) ?></td>
            </tr>
        </table>
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th>Nama Makanan / Item</th>
                    <th style="width: 80px;">Suhu (°C)</th>
                    <th style="width: 100px;">Jam Matang</th>
                    <th style="width: 100px;">Jadwal Saji</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="sig-section">
            <table class="sig-table">
                <tr>
                    <td class="sig-box">
                        <p>Dibuat Oleh (Cook),</p>
                        <div class="sig-space"></div>
                        <p class="sig-name">( <?= esc($header['nama_pelaksana']) ?> )</p>
                    </td>
                    <td class="sig-box">
                        <p>Diperiksa Oleh (Ahli Gizi),</p>
                        <div class="sig-space"></div>
        ...
        <div style="margin-top: 30px; font-size: 9px; color: #666; text-align: center; border-top: 1px dotted #000; padding-top: 8px;">
            Halaman 1 dari 1 | SIM-GIZI Cooking Temperature Log | Dicetak pada: <?= date('d/m/Y H:i') ?>
        </div>
    </div>
</body>
</html>
