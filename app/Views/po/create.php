...
<?= $this->include('layout/print_blank_button', ['printBlankUrl' => 'po/export-pdf-blank']) ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="analisis_gizi_id" id="akgSelect" class="form-select">
                                ...
                                <?php foreach ($akgs as $akg): ?>
                                    <option value="<?= $akg['id'] ?>"><?= $akg['nama_paket'] ?> (<?= date('d/m/Y', strtotime($akg['tanggal_sajian'])) ?>)</option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="menu" id="menuInput" class="form-control" placeholder="Contoh: Nugget Ayam, atau Operasional (Gas, dll)">
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-premium align-middle" id="itemTable">
                        ...
                        <tbody>
                            <tr class="item-row">
                                ...
                                <td><input type="number" step="0.01" name="items[0][qty]" class="form-control form-control-sm qty-input" required></td>
                                <td><input type="text" name="items[0][satuan]" class="form-control form-control-sm" required placeholder="Kg/Pcs"></td>
                                <td><input type="text" name="items[0][nama_barang]" class="form-control form-control-sm" required></td>
                                <td><input type="number" step="0.01" name="items[0][harga_satuan]" class="form-control form-control-sm harga-input" value="0"></td>
                                <td><input type="number" step="0.01" name="items[0][tambahan]" class="form-control form-control-sm tambahan-input" value="0"></td>
                                <td><input type="number" step="0.01" name="items[0][jumlah_faktual]" class="form-control form-control-sm faktual-input" value="0"></td>
                                <td><input type="text" class="form-control form-control-sm text-end row-total bg-light" value="Rp 0" readonly></td>
                                <td><input type="text" name="items[0][catatan]" class="form-control form-control-sm"></td>
                                <td class="text-end">
