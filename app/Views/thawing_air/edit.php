...
<div class="mb-4 animate-in">
    ...
    <h4 class="mb-1" style="font-weight: 700;">Edit Checklist Thawing Air</h4>
</div>
<form action="<?= site_url('thawing-air/update/' . $header['id']) ?>" method="post">
    ...
    <div class="data-card mt-4 animate-in" style="animation-delay: 0.2s;">
            ...
            <table class="table table-premium mb-0" id="item-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="items[<?= $i ?>][suhu_air]" class="form-control form-control-sm" value="<?= $item['suhu_air'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][waktu_thawing]" class="form-control form-control-sm" value="<?= $item['waktu_thawing'] ?>"></td>
        ...
        <div class="card-body bg-light border-top p-3 text-end"><button type="submit" class="btn btn-primary px-4">Perbarui Checklist</button></div>
    </div>
</form>
<script>
