...
<body onload="window.print()">
    ...
    <div class="page-container">
        ...
        <div class="title-main">CHECKLIST THAWING (METODE AIR MENGALIR)</div>
        ...
        <table class="data-table">
            <thead>
                <tr><th width="30">No</th><th>Nama Bahan</th><th width="100">Jumlah</th><th width="100">Suhu Air (°C)</th><th>Waktu Thawing (Jam)</th><th width="80">Paraf</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= esc($item['suhu_air']) ?> °C</td>
                    <td><?= esc($item['waktu_thawing']) ?></td>
        ...
        <div class="sig-section">
            <table class="sig-table">
                <tr>
                    ...
                    <td class="sig-box">
                        <p>Diverifikasi Oleh (Ahli Gizi),</p>
                        <div class="sig-space"></div>
                        <p class="sig-name">( .................................. )</p>
                    </td>
                </tr>
        ...
        <div style="margin-top: 30px; font-size: 9px; color: #666; text-align: center; border-top: 1px dotted #000; padding-top: 8px;">
            Halaman 1 dari 1 | SIM-GIZI Thawing Log | Dicetak pada: <?= date('d/m/Y H:i') ?>
        </div>
    </div>
</body>
</html>
