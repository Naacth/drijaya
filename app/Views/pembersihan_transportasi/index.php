                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $f['nama_kendaraan'] ?></td>
                            <td>
                                <span class="badge bg-light text-dark border"><?= $f['user_nama'] ?></span>
                            </td>
                            <td class="text-end pe-4">
                                <a href="<?= site_url('pembersihan-transportasi/show/' . $f['id']) ?>" class="btn btn-outline-primary btn-sm px-3 rounded-pill">
                                    Detail
                                </a>
                                <?php if(session()->get('role') == 'ahli_gizi'): ?>
                                <a href="<?= site_url('pembersihan-transportasi/edit/' . $f['id']) ?>" class="btn btn-outline-secondary btn-sm px-3 rounded-pill ms-1">
                                    Edit
                                </a>
                                <?php endif; ?>
