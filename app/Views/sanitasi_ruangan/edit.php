        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0">Edit Form Sanitasi Ruangan & Peralatan</h5>
                </div>
                <div class="card-body">
                    <form action="<?= site_url('sanitasi-ruangan/update/' . $header['id']) ?>" method="post">
                        <div class="row mb-4">
                        ...
                        <div class="row">
                            ...
                            foreach ($items as $item): 
                                ...
                                $checked = isset($fasilitas[$key]) && $fasilitas[$key] == '1' ? 'checked' : '';
                            ?>
                            <div class="col-md-6 mb-2">
                                <div class="form-check form-switch p-2 border rounded">
                                    <input class="form-check-input ms-0 me-2" type="checkbox" name="fasilitas[<?= $key ?>]" value="1" id="<?= $key ?>" <?= $checked ?>>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_pelaksana" class="form-control" placeholder="Nama petugas pelaksana" value="<?= $header['nama_pelaksana'] ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nama Pemeriksa</label>
                                <input type="text" name="nama_pemeriksa" class="form-control" placeholder="Nama ahli gizi/pengawas" value="<?= $header['nama_pemeriksa'] ?>" required>
                            </div>
                        </div>
