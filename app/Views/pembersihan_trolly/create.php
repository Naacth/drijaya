...
<?= $this->include('layout/print_blank_button', ['printBlankUrl' => 'pembersihan-trolly/export-pdf-blank']) ?>


<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <form action="<?= site_url('pembersihan-trolly/store') ?>" method="post">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="mb-0">Buat Laporan Pembersihan Trolly Makanan</h5>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <table class="table table-bordered align-middle" id="dynamicTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="rekap[0][keterangan]" class="form-control form-control-sm" placeholder="Contoh: Bersih & Kering"></td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card-footer bg-light text-end py-3">
                        <a href="<?= site_url('pembersihan-trolly') ?>" class="btn btn-link link-secondary me-3">Batal</a>
...
function addRow() {
    ...
    newRow.innerHTML = `
        ...
        <td><input type="text" name="rekap[${rowCount}][keterangan]" class="form-control form-control-sm" placeholder="Contoh: Bersih & Kering"></td>
