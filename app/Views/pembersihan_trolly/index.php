...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2 align-items-center">
            <?= $this->include('layout/print_blank_button', ['printBlankUrl' => 'pembersihan-trolly/export-pdf-blank', 'printBlankRoles' => ['ahli_gizi', 'admin'], 'printBlankWrapperClass' => 'mb-0']) ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                ...
                                <a href="<?= site_url('pembersihan-trolly/delete/' . $f['id']) ?>" class="btn btn-outline-danger btn-sm px-3 rounded-pill ms-1" onclick="return confirm('Hapus data ini?')">
                                    Hapus
                                </a>
                                <?php endif; ?>
                            </td>
