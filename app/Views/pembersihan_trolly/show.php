...
<div class="d-flex justify-content-between align-items-center mb-4 animate-in">
    <div>
        <a href="<?= site_url('pembersihan-trolly') ?>" class="text-decoration-none text-muted mb-2 d-inline-block small">
    ...
    <div class="d-flex gap-2">
        ...
        <?php endif; ?>
        <a href="<?= site_url('pembersihan-trolly/export-pdf/' . $header['id']) ?>" target="_blank" class="btn btn-outline-danger btn-sm px-3 rounded-pill shadow-sm">
            <i class="fas fa-file-pdf me-1"></i> Cetak PDF
        </a>
        <a href="<?= site_url('pembersihan-trolly/export-excel/' . $header['id']) ?>" class="btn btn-outline-success btn-sm px-3 rounded-pill shadow-sm">
    ...
    <div class="card-body p-4">
        <div class="row mb-4 pb-3 border-bottom text-center text-md-start">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                ...
                <p class="mb-0"><span class="badge bg-light text-dark border">#TRL-<?= str_pad($header['id'], 5, '0', STR_PAD_LEFT) ?></span></p>
            </div>
        </div>
            ...
            <table class="table table-hover align-middle">
                <thead class="bg-light small fw-bold text-uppercase">
                    <tr>
                        ...
                        <th>Keterangan (Kondisi Trolly)</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-outline-info text-info border border-info fw-normal"><?= date('d M Y', strtotime($row['tanggal'])) ?></span></td>
