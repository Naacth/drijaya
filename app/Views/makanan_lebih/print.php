...
<body onload="window.print()">
    ...
    <div class="page-container">
        ...
        <table class="info-table">
            ...
            <tr><td>Cook</td><td>: <?= esc($header['nama_cook']) ?></td></tr>
            <tr><td>Chef</td><td>: <?= esc($header['nama_chef'] ?: '-') ?></td></tr>
            <tr><td>Ahli Gizi</td><td>: <?= esc($header['nama_ahli_gizi'] ?: '-') ?></td></tr>
        </table>
        <table class="data-table">
            <thead>
                <tr><th width="30">No</th><th>Nama Item Lebih</th><th width="100">Jumlah</th><th>Kondisi</th><th>Tindakan</th></tr>
            </thead>
            <tbody>
        ...
        <table class="sig-block">
            <tr>
                <td><p>Cook</p><div class="sig-space"></div><p>( <?= esc($header['nama_cook']) ?> )</p></td>
