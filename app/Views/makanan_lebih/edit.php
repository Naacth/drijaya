...
<div class="mb-4 animate-in">
    ...
    <h4 class="mb-1" style="font-weight: 700;">Edit Form Makanan Lebih</h4>
</div>
<form action="<?= site_url('makanan-lebih/update/' . $header['id']) ?>" method="post">
    <div class="data-card animate-in" style="animation-delay: 0.1s;">
        <div class="card-body p-4">
            <div class="row g-3">
                ...
                <div class="col-md-3"><label class="form-label">Nama Cook</label><input type="text" name="nama_cook" class="form-control" required value="<?= $header['nama_cook'] ?>"></div>
        ...
        <div class="table-responsive">
            <table class="table table-premium mb-0" id="item-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="text" name="items[<?= $i ?>][nama_item]" class="form-control form-control-sm" required value="<?= $item['nama_item'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][jumlah]" class="form-control form-control-sm" value="<?= $item['jumlah'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][kondisi]" class="form-control form-control-sm" placeholder="Layak/Tidak" value="<?= $item['kondisi'] ?>"></td>
                        <td><input type="text" name="items[<?= $i ?>][tindakan]" class="form-control form-control-sm" placeholder="Dibuang/Simpan" value="<?= $item['tindakan'] ?>"></td>
