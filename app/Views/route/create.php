...
<div class="container-fluid animate-in">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-0">Buat Rute Pengiriman</h4>
            <p class="text-muted small">Tentukan mobil, driver, dan jadwal pengantaran ke sekolah.</p>
        </div>
    ...
    <div class="data-card">
        <div class="card-body p-4">
            <form action="<?= base_url('routes/store') ?>" method="POST" id="routeForm">
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="driver" class="form-control" required placeholder="Contoh: Pak Bustomi">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label text-uppercase small ls-1">Nama SPPG</label>
                            <input type="text" name="sppg" class="form-control" required value="Dapur SPPG Bunar">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                    ...
                    <table class="table table-premium align-middle" id="itemTable">
                        ...
                        <tbody>
                            <tr class="item-row">
                                ...
                                <td><input type="time" name="items[0][jam_antar]" class="form-control form-control-sm" required></td>
                                <td>
                                    <select name="items[0][sesi]" class="form-select form-select-sm" required>
                ...
                <div class="row mt-4">
                        ...
                        <div class="data-card bg-light border-0">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="fw-bold h5 mb-0 text-primary" id="grandTotalPorsi">0</span>
                                </div>
                    ...
                    <div class="col-md-6 text-end align-self-center">
                        ...
                        <button type="submit" name="action" value="submit" class="btn btn-primary px-4 h6 mb-0 py-2">
                            <i class="bi bi-send-fill me-2"></i>Submit Rute
                        </button>
                    </div>
                </div>
            </form>
